...
internal sealed class SelectDeanLevel(int deanCode, string fullName, string shortName)
{
    public int DeanCode { get; set; } = deanCode;
    public string FullName { get; set; } = fullName;
    public string ShortName { get; set; } = shortName;

    public SelectDeanLevel() : this(-1, string.Empty, string.Empty) { }
